...
## Experiments
- `Exp1/` - Git installation + repository workflow (README included)
- `Exp2/` - Static HTML/CSS layout (with assets)
- `Exp3/` - JavaScript interactive UI with external script and styles
- `Exp4/` - HTML web page demo
- `Exp5/` - AJAX-based demo with dynamic data loading and async request handling
- `Exp6/` - PHP (database-backed page) with `db.php` + `index.php`
